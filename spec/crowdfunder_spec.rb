...
#     before { @sql_runner.execute_create_sql }

#     it 'creates a projects table with an id as a primary key' do
#       expect(
#         @db.execute('PRAGMA table_info(projects);').detect { |arr|
#           arr[-1] == 1 && arr[2] == 'INTEGER'
#         }.length
#       ).to eq(6)
#     end
...
#       expect(
#         @db.execute('PRAGMA table_info(pledges);').detect { |arr|
#           arr[-1] == 1 && arr[2] == 'INTEGER'
#         }.length
#       ).to eq(6)
#     end
...
#       expect {
#         @db.execute('SELECT amount FROM pledges;')
#       }.to_not raise_exception
#     end

#     it 'creates a pledges table with a user_id field' do
#       expect {
#         @db.execute('SELECT user_id FROM pledges;')
#       }.to_not raise_exception
#     end

#     it 'creates a pledges table with a project_id field' do
#       expect {
#         @db.execute('SELECT project_id FROM pledges;')
#       }.to_not raise_exception
#     end
#   end
...
#         )
#       ).to eq([['My book on SQL', 0], ['The next Inna-Gadda-Davida', 142]])
#     end
